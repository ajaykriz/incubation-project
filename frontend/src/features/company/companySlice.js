...
export const pendingApplication = createAsyncThunk(
  "users/pendingApplication",
  () => {
    return axios({
      method: "get",
...
export const registeredApplication = createAsyncThunk(
  "users/registeredApplication",
  () => {
    return axios({
      method: "get",
...
export const blockedApplication = createAsyncThunk(
  "users/blockedApplication",
  () => {
    return axios({
      method: "get",
